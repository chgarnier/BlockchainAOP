...
type OliveAOP struct {
	Poids float32 `json:"poids"`
	DateRecolte string `json:"daterecolte"`
	Lieu  string `json:"lieu"`
	Producteur  string `json:"producteur"`
}

type ProduitAOP struct {
	Nom string `json:"vessel"`
	Type string `json:"timestamp"`
	Transformateur  string `json:"location"`
	OlivesAOP  []OliveAOP `json:"olivesaop"`
}
